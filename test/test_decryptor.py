...
from cryptography.hazmat.decrepit.ciphers.algorithms import Camellia, ARC4, TripleDES
...
class TestTls13Decryptor(TestCase):
    def setUp(self) -> None:
        self.tls_1_3_chacha20_poly1305_decryptor = Decryptor(
            ChaCha20Poly1305,
            ChaCha20Poly1305,
            SHA256,
            {
        ...
        self.tls_1_3_aes_128_gcm_decryptor = Decryptor(
            AESGCM,
            AESGCM,
            SHA256,
            {
                ...
                "server_application_iv": b"hY\x0e\xb2\xc7\xce4\xf4\x0e\x9bL\r",
            },
            TlsVersion.TLS13,
            16,
            32,
        ...
        self.tls_1_3_aes_256_gcm_decryptor = Decryptor(
            AESGCM,
            AESGCM,
            SHA384,
            {
        ...
        self.tls_1_3_aes_128_ccm_decryptor = Decryptor(
            AESCCM,
            AESCCM,
            SHA256,
            {
        ...
        self.tls_1_3_aes_128_ccm_8_decryptor = Decryptor(
            AESCCM,
            AESCCM,
            SHA256,
            {
    ...
    def test_aes_128_ccm_8(self):
        ...
        client_1 = TlsRecord(
            bytearray(
                b"\x17\x03\x03\x00\x11\x05\xfc\xce\x9aR\xd8\n\x11Y\xd5x\xd6}\xc9\xfb\xccH"
            ),
            [],
            False,
        )
        ...
        client_app_1 = TlsRecord(
            bytearray(
                b"\x17\x03\x03\x00\x0f\xb5\x8a\xed,*\xf9B\xf0\xe8\x11(\x99\xd0\x8a\x13"
            ),
            [],
            False,
        )
        server_app_3 = TlsRecord(
            bytearray(b"\x17\x03\x03\x00\x0f\x01\x80\xf6_^h\xb5ar5\x98\xe4\xfay,"),
            [],
            True,
        )

        self.assertEqual(
            self.tls_1_3_aes_128_ccm_8_decryptor.decrypt(server_1, True),
            b"\x08\x00\x00\x08\x00\x06\x00\x1c\x00\x02@\x01\x16",
        )
        self.assertEqual(
            self.tls_1_3_aes_128_ccm_8_decryptor.decrypt(server_2, True),
        ...
        self.assertEqual(
            self.tls_1_3_aes_128_ccm_8_decryptor.decrypt(server_3, True),
        ...
        self.assertEqual(
            self.tls_1_3_aes_128_ccm_8_decryptor.decrypt(server_4, True),
        ...
        self.assertEqual(
            self.tls_1_3_aes_128_ccm_8_decryptor.decrypt(server_5, True),
        ...
        self.assertEqual(
            self.tls_1_3_aes_128_ccm_8_decryptor.decrypt(client_1, False),
            b"\x0b\x00\x00\x04\x00\x00\x00\x00\x16",
        )
        self.assertEqual(
            self.tls_1_3_aes_128_ccm_8_decryptor.decrypt(client_2, False),
        ...
        self.assertEqual(
            self.tls_1_3_aes_128_ccm_8_decryptor.decrypt(server_app_1, True),
        ...
        self.assertEqual(
            self.tls_1_3_aes_128_ccm_8_decryptor.decrypt(server_app_2, True),
        ...
        self.assertEqual(
            self.tls_1_3_aes_128_ccm_8_decryptor.decrypt(client_app_1, False),
            b"Lorem\n\x17",
        )
        self.assertEqual(
            self.tls_1_3_aes_128_ccm_8_decryptor.decrypt(server_app_3, True),
            b"Lorem\n\x17",
        )
    ...
    def test_aes_128_ccm(self):
        ...
        client_1 = TlsRecord(
            bytearray(
                b"\x17\x03\x03\x00\x19\x05M@\xa1\xc0b>\xdfdv?C\x02\xf4\x0cY\xf21b\x1e\x92^Dd'"
            ),
            [],
            False,
        )
        ...
        client_app_1 = TlsRecord(
            bytearray(
                b"\x17\x03\x03\x00\x17\x98\x7f|\x1f\xc5I\xa9\x99N\x8c\xb7\xf2/\x9c[Lz\xfa\x82Wn`\xc0"
            ),
            [],
            False,
        )
        server_app_3 = TlsRecord(
            bytearray(
                b"\x17\x03\x03\x00\x17P|_u\x9d\xf3\xadoD\xcf)3\xe9\x1e .\xf8\x88\\c\xda:\x85"
            ),
            [],
            True,
        )
        ...
        self.assertEqual(
            self.tls_1_3_aes_128_ccm_decryptor.decrypt(server_1, True),
            b"\x08\x00\x00\x08\x00\x06\x00\x1c\x00\x02@\x01\x16",
        )
        self.assertEqual(
            self.tls_1_3_aes_128_ccm_decryptor.decrypt(server_2, True),
            b'\r\x00\x00-\x00\x00*\x00\r\x00"\x00 \x04\x01\x08\t\x08\x04\x04\x03\x08\x07\x05\x01\x08\n\x08\x05\x05\x03\x08\x08\x06\x01\x08\x0b\x08\x06\x06\x03\x02\x01\x02\x03\x00\x05\x00\x00\x16',
        )
        self.assertEqual(
            self.tls_1_3_aes_128_ccm_decryptor.decrypt(server_3, True),
            b'\x0b\x00\x05\xa0\x00\x00\x05\x9c\x00\x05\x970\x82\x05\x930\x82\x03{\xa0\x03\x02\x01\x02\x02\x14\x1aY\xdfW$L\x97V\xf9\xe8\\3\xaa\xf5\x81\xbf\xc08\xf3E0\r\x06\t*\x86H\x86\xf7\r\x01\x01\x0b\x05\x000Y1\x0b0\t\x06\x03U\x04\x06\x13\x02AU1\x130\x11\x06\x03U\x04\x08\x0c\nSome-State1!0\x1f\x06\x03U\x04\n\x0c\x18Internet Widgits Pty Ltd1\x120\x10\x06\x03U\x04\x03\x0c\tlocalhost0\x1e\x17\r230926104549Z\x17\r240925104549Z0Y1\x0b0\t\x06\x03U\x04\x06\x13\x02AU1\x130\x11\x06\x03U\x04\x08\x0c\nSome-State1!0\x1f\x06\x03U\x04\n\x0c\x18Internet Widgits Pty Ltd1\x120\x10\x06\x03U\x04\x03\x0c\tlocalhost0\x82\x02"0\r\x06\t*\x86H\x86\xf7\r\x01\x01\x01\x05\x00\x03\x82\x02\x0f\x000\x82\x02\n\x02\x82\x02\x01\x00\xe1\xd5\x88\x9e\xcbhEC\xbf\xe2x\xc4\xef\xd9\xb6A\x08>\xe2\xe4A\xb94\xd3\x06#\xd9\xf6~\x95\x1a9h-j\x8d\xd3_\xef\xb1\x19l\xbfO\xa3\xc8\xf5t2\\+\xee$\xbb\xb8EF\xc9\xf5`\xaeJhF-\xbd\r\xa9E\t\xceS\t\xf9\xc6By?eT\x9420\xd5\xfd\x19\x12~\xa8\x8a\x92\xaf\xf2U\xba\x1b!F\x81\tM\\\xfd|\xc6\x7f\xfb\xb2\xe3\xf1\xfcB\x1frn:8\xf6\x15\x1e\xba\x0e2\xfe\xd0\x95u=\x83\x1f\x1dx\xe7\x1a\xce\xe8\xf8<\x90\x92e\xd5B\xbeo\xfc\x9f;\xfe\x97\x19\xc5\x04\xe5\xf77@\x94\xbd\x08\x7f\xbe\x9e\x11\xc5\x96\xe6\xb0\xfa\\l\xd6\xf2\\.\x03f\x7f\x19\x1b\xaf1\xef\xcc\xba}\x10aL3 \xef\xde\xf2\xcaij\xc0\xa5\x15\x8ci6\xe7\xaa\xea!\xf8q)\x9c\x9ea\x0fuj\x07\xe2$\xb4R\xf0\x00:\xf0\x1b\x15\x1c;\x81\xc6/\'\xca\xfc\x97*7\xcb\x16*\xfc\xbeJ\xfc\xec\xe7\xf6\x14ej\x0582v6\xf3\x0b1\xdb\xad#\x91^\xa9\xf1q\x03\x16\xaf\xfc\xca\x88\xcc4\xe2\x862\xb6\x80\x1b)\x858\x16\t\x145\x8c\xa6\xb7\x85\xfa`\xd9\x8d\xf9\\\xfdx\xfbA\xb8Z\x9c\xaa\xb0\x9b\x85\x80\xf9$z\xa4\x8f\xa0\xd7\x94\x94\xa5<\xa7\xb6\xac\xde\xa8n\x99\xa5\xa6w\x0e+$G=DY\x98/\x0c\xa6:\xd5:em\\\xb2"\x97\xbe6\x96\x04P\n\xb3\xe0&?\x97\xe7\x03\xa2J\x97\x87qo(pHsu\x18\x88\xf1\x89]\x04\xb0\xa3\xb51\x1fa{\x030\xe3\xc3\xe88\xc4\xcch\x81\x9d\x0c\x15\x96\x93ynx}\xbd\xbdM\xfa3\xdd\xc9\x0f\x00\xc7pxIrs\xa9U\xc0.\x81C\xb2\t\xd4\xab\xbf\xde\xbeo\xee\x8a\xa73\x97\xa0_\xe1\xadreN\xf0\xd4]\xee\xc0\x0c\x06\xbaB%:I\x96\x92~\xbb\xf0B7\xd1\x16$FS\xc1\xc1kT\xd4V\xb1\xe1\xe6\xffs\xf5\xad\xa7;D\xae\xb5\xa44\x1e\xf5V \xd5q\xe3\xcfj\xca%\xe8\xd1\x9ev_{\rCW\x02\x03\x01\x00\x01\xa3S0Q0\x1d\x06\x03U\x1d\x0e\x04\x16\x04\x14j\\\xd67\x97r`\xf0\xc2|\xb5|\xf5y\xa1Qy\x03E\x180\x1f\x06\x03U\x1d#\x04\x180\x16\x80\x14j\\\xd67\x97r`\xf0\xc2|\xb5|\xf5y\xa1Qy\x03E\x180\x0f\x06\x03U\x1d\x13\x01\x01\xff\x04\x050\x03\x01\x01\xff0\r\x06\t*\x86H\x86\xf7\r\x01\x01\x0b\x05\x00\x03\x82\x02\x01\x00s\xe7\xbc\xec\xd7\xbf\x96_r\x94\xdd\xf0\x1f\xea\x9d\xbe%\x1dn\xeb3\xce\xb9}+\xe5\xadk\xe1\x99\x10\x95\xc65\x9f]\xb2\x19O\x86u{\x191"\x90/ \x88\xa70\x13\xe3\x1a\x92 \xf8\x9b\xf7\x88g\x89\xd6\xdc5\xb6C~\x91\xbdO\xe6&\xbb\xec\xab#\xf8\xce8\xb6n\x9f\xe0\xf4\xb2\xd0\xfa\xb7T4\r\xf0\xd8\x8c\x13\xe8\x199\xd0a\xbb#\n\xfe\xb1/\xe5\xb0\x9dT`\xfa\x94#~\xbe3~B\x04@o.R\xba\x91<\xd0\xbc\xae,\x0b`ZN{\x06\x04\xce\x11Kb\x95\x8a>\xd4\xd1$\xde\xba\x8dA\tV\xb5M\xc8\xaa\x98\x03\x0er\x02\x07\x8fF\xa7\xd1=\xc7\x85g9\x82\xba\xfaJ\xe9m\xd6\xff\xa8F\nYO\nng*\x84\xebKz\xb67\x8c@u\xebC \x96L\xc9Lv\xb1:z\xa8\xe9pN\x98\xf8\xab\x11?\x96\x86A2\x90\xb5\xf5\x9e\x88A87>\xbb\xd1H\xc13P\xa8\xd0H\x8b8P-sK\xf08\x8132\xdc_\xca\x92\xbd\x9f\xdc\x8d\x84o\xc7\x19\xd2\xfbG\xbe\x16_\x96Ev\xba\x82\xcb\xe2\xe8\xc6+9\x1b$ \xb3\xc2bFD\x8a\xce\xd2\xb83t\x1c\xbe^\xa3\xfc\x83\xb7\t\xbe\xda\x81\x81g6(v\xd7\xdfU\x98\xfd@fL\xdb\xe7\xdc\xaf\xbb\xac\xe0yM\xe5\\\'d\xb8x\xf6\xf3\x14\xcet^\xf5\x19t\xa5~\xa5\xc2+I\xfc\x0ec\xd8:/\xb6\x02\xe4\xa3\x13\xa1\x7fbo\xba\xa6m\xb3\xe5\x87YS\xea\xcb\x9b\x0fa\xf4\xd1\x93^t\x06\x9fLJ\x9b%\x0c\x93G\xbcz\x89\x1e\x08\x02\xb5\x99\xe8\xfb\xfc[\xcb\xb0\x1eA<\x80\xb6\xcd\xb2\x02\xbf\xb1ig\xa4\xf0\x82\xac\x82\xba\x85e\xd9-\r\x9d\xeb\x12@p\xa6v\xc5\x94\xf3}\xafV\x1e*\x9c\x99\xbdy\xa2{\xcc\xdb\xc0\x85\xdd\x00\xda\xb4\x8c1\xb5s\x03\x11qk\xcf\xa8\x06\xbf\xda&b\x03R\xde\xaf\xadK\xb9\x1f\xc8F\xcc\xbb\xd3\xf5\x10\x90n\t\x0e)\xc3\xa9V\x9f\xd5\xf8*\xfc\x9fv\xb5\xf7\x18\x90w\xae\xcfc\x1a\x00\x00\x16',
        )
        self.assertEqual(
            self.tls_1_3_aes_128_ccm_decryptor.decrypt(server_4, True),
        ...
        self.assertEqual(
            self.tls_1_3_aes_128_ccm_decryptor.decrypt(server_5, True),
        ...
        self.assertEqual(
            self.tls_1_3_aes_128_ccm_decryptor.decrypt(client_1, False),
            b"\x0b\x00\x00\x04\x00\x00\x00\x00\x16",
        )
        self.assertEqual(
            self.tls_1_3_aes_128_ccm_decryptor.decrypt(client_2, False),
        ...
        self.assertEqual(
            self.tls_1_3_aes_128_ccm_decryptor.decrypt(server_app_1, True),
        ...
        self.assertEqual(
            self.tls_1_3_aes_128_ccm_decryptor.decrypt(server_app_2, True),
        ...
        self.assertEqual(
            self.tls_1_3_aes_128_ccm_decryptor.decrypt(client_app_1, False),
            b"Lorem\n\x17",
        )
        self.assertEqual(
            self.tls_1_3_aes_128_ccm_decryptor.decrypt(server_app_3, True),
            b"Lorem\n\x17",
        )
    ...
    def test_aes_256_gcm(self):
        server_1 = TlsRecord(
            bytearray(
                b"\x17\x03\x03\x00\x17\xd199O\xbe\xee\xb5\xaf(\x82#%3\xbd\x9a\xc0\xfe\x822\xdb@\x1du"
            ),
            [],
            True,
        )
        ...
        server_app_3 = TlsRecord(
            bytearray(
                b"\x17\x03\x03\x00\x17\xf1X\xa83.\x15\xaa\xfd\x146\x8d]\r\x18TA}\xb7X\xb1!\xd6V"
            ),
            [],
            True,
        )
        ...
        self.assertEqual(
            self.tls_1_3_aes_256_gcm_decryptor.decrypt(server_1, True),
            b"\x08\x00\x00\x02\x00\x00\x16",
        )
        self.assertEqual(
            self.tls_1_3_aes_256_gcm_decryptor.decrypt(server_2, True),
        ...
        self.assertEqual(
            self.tls_1_3_aes_256_gcm_decryptor.decrypt(server_3, True),
        ...
        self.assertEqual(
            self.tls_1_3_aes_256_gcm_decryptor.decrypt(server_4, True),
        ...
        self.assertEqual(
            self.tls_1_3_aes_256_gcm_decryptor.decrypt(client_1, False),
        ...
        self.assertEqual(
            self.tls_1_3_aes_256_gcm_decryptor.decrypt(server_app_1, True),
        ...
        self.assertEqual(
            self.tls_1_3_aes_256_gcm_decryptor.decrypt(server_app_2, True),
        ...
        self.assertEqual(
            self.tls_1_3_aes_256_gcm_decryptor.decrypt(client_app_1, False),
            b"Lorem\n\x17",
        )
        self.assertEqual(
            self.tls_1_3_aes_256_gcm_decryptor.decrypt(server_app_3, True),
            b"Lorem\n\x17",
        )
    ...
    def test_aes_128_gcm(self):
        server_1 = TlsRecord(
            bytearray(
                b"\x17\x03\x03\x00\x17\x1a\x9fM\xe5L\xc8\xcax\x97\x9eq\xd0\x92\xc8\xfd\rm\xc0A\xed\xe3}\xa1"
            ),
            [],
            True,
        )
        ...
        client_app_1 = TlsRecord(
            bytearray(
                b"\x17\x03\x03\x00\x17\xd5#\x99c&A\xc2a|7\x8ce\xe6\xf1\xc4i2\x92\x8a\xd2\x06Q\xfc"
            ),
            [],
            False,
        )
        server_app_3 = TlsRecord(
            bytearray(
                b"\x17\x03\x03\x00\x17L\xdfo\xc5S\x17\xfd\x0e^\xe0\n\x14\xbe/\xa6\xdc[\xc2\x0c\xfa\xad@\xca"
            ),
            [],
            True,
        )
        ...
        self.assertEqual(
            self.tls_1_3_aes_128_gcm_decryptor.decrypt(server_1, True),
            b"\x08\x00\x00\x02\x00\x00\x16",
        )
        self.assertEqual(
            self.tls_1_3_aes_128_gcm_decryptor.decrypt(server_2, True),
            b"\x0b\x00\x03x\x00\x00\x03t\x00\x03o0\x82\x03k0\x82\x02S\xa0\x03\x02\x01\x02\x02\x14zC\xc1\xae\xee\x84$\xbc\xe2\x95\xd9h\xc5\x15V\xcc\xd3\xf8\x1e\x130\r\x06\t*\x86H\x86\xf7\r\x01\x01\x0b\x05\x000E1\x0b0\t\x06\x03U\x04\x06\x13\x02AU1\x130\x11\x06\x03U\x04\x08\x0c\nSome-State1!0\x1f\x06\x03U\x04\n\x0c\x18Internet Widgits Pty Ltd0\x1e\x17\r230926081013Z\x17\r240925081013Z0E1\x0b0\t\x06\x03U\x04\x06\x13\x02AU1\x130\x11\x06\x03U\x04\x08\x0c\nSome-State1!0\x1f\x06\x03U\x04\n\x0c\x18Internet Widgits Pty Ltd0\x82\x01\"0\r\x06\t*\x86H\x86\xf7\r\x01\x01\x01\x05\x00\x03\x82\x01\x0f\x000\x82\x01\n\x02\x82\x01\x01\x00\xdb\x85\xeb2^\xa7\x02y5\xf1}=\xad\xdf\x0c\xf6\xcd\xbc\x1e\xfe\x01\x195A~wI;1\xbe\xc11?\x06\xca\xb2\xac\xc7\xa1\xba\xb6\xe0\xd5\xb0+_\xa2i\xc4y\x97\x17\xcc&\xa4\x0cv\x8c\xb8\xb1\xbc\x89\x1e\xf1f_Z\xa1\x00\x0c\x01Hm\xae\xe6\x00K\xa2\xabj:6\xa7\x02`\xef\xeb\x95C\xc4\xa0\x1eH~]\xf6\xf9\xc5{\xbc\xa3\x9c\xd6\x9e\xf6\x88G\xbd\xa5\xa1\\\xa5\xdd>\xec\xc6\x03\x86\x101\x12\x1e)\xb7\xbdc\xdc(\xfe\xc4%\x14i3u\xe1\x93\xa4<G\x11\xf0\xe1\xd5\xe6\xdd\x14)\xf8\xc8\xa6\xd6S\xa0\xf5<\x1ep~\x1cD\x8c] P\xd8%t.\x85I\x9b\xd2\xdb\x14%wb\xfa\xd3\xd9\xdd\xcf\x05'(\x90\xbdY\x02\x1c\x18\x7f\xdfr\xc1dYr\x15\xe4\n\xd4\xdb\x1c\xc9G\xc7\xea\xe4\x1a\xc9\x12L\xeav.\xcb&z\t$\xa1\xbf\xc8t\xdbM\xc6+\xd26pC\xbey\xe6\x16rVn\xe9\x97\x9d[#dT\xa4\x91XR\xd8\xd5$E\x02\x03\x01\x00\x01\xa3S0Q0\x1d\x06\x03U\x1d\x0e\x04\x16\x04\x14\xdf3\xd5\xd9\xec\xd6\xab\xb0Fc\xd6t\\\xbdl\xb4l\x00\xf6x0\x1f\x06\x03U\x1d#\x04\x180\x16\x80\x14\xdf3\xd5\xd9\xec\xd6\xab\xb0Fc\xd6t\\\xbdl\xb4l\x00\xf6x0\x0f\x06\x03U\x1d\x13\x01\x01\xff\x04\x050\x03\x01\x01\xff0\r\x06\t*\x86H\x86\xf7\r\x01\x01\x0b\x05\x00\x03\x82\x01\x01\x002IA\xe21\x9a\xcaY\xc4\xba\xf4\xd6\xbe><\xcf\x81f\xac\x03\x03\xba\n<\xcc\xd0e\xf2\x07\xd4\xe3\x11u\x02*\x02\xf6u\x14n\xd7qz\xcd\x0ck\xbf;O\x8cA\xb0R\x8a\x86\xceg3hv.\x12\xa1\xb7\xfa{\xcf\x01qz\x95rn\xbb\x83B[~\x1110\xe7\xa9Z-\x9b\xbdR\x12\xa0mt\xf8iHL\xaa\x05jI\xc6\n\x84\xc9\xfbK\x8c\xd2\xe1\xe2s\xa1L\xe4J\x9d\xe6\xfeM\x82_\xcd\xe4s'I\xd9\xf7\xca0\x84\xaa\xef&\xd5\xd6\x82\xe3,\x8bp\xedH\x95\xfc\x15\xeaB\xaa\xac0\xa9\x84\x92\xed}\xb9\xc6\x8dg\x02Q\xf5k\x89\x04\xe1A\xc7\x99\x9b\xef;O2\x12\xa1u\x0eX\xfaz\x01\x1a\xe6+\x08w\x04\xb2\x0cja(\x13!\x19\x0ct\xf7\x05\xc5\xd1\n.\xbc\xc4\x83i9!\\\x89\x14\xd0XGM)\xeb+t\xfd\x00\x17\x89\xc4\x97{\x05U\x88\x8d\xec\x9a\x89\x96\xeb\xc7U%0NJ\xfd5\xb2\x0e\x94\xa9\xbf\xd7\xb6 #|\x00\x00\x16",
        )
        self.assertEqual(
            self.tls_1_3_aes_128_gcm_decryptor.decrypt(server_3, True),
        ...
        self.assertEqual(
            self.tls_1_3_aes_128_gcm_decryptor.decrypt(server_4, True),
        ...
        self.assertEqual(
            self.tls_1_3_aes_128_gcm_decryptor.decrypt(client_1, False),
        ...
        self.assertEqual(
            self.tls_1_3_aes_128_gcm_decryptor.decrypt(server_app_1, True),
        ...
        self.assertEqual(
            self.tls_1_3_aes_128_gcm_decryptor.decrypt(server_app_2, True),
        ...
        self.assertEqual(
            self.tls_1_3_aes_128_gcm_decryptor.decrypt(client_app_1, False),
            b"Lorem\n\x17",
        )
        self.assertEqual(
            self.tls_1_3_aes_128_gcm_decryptor.decrypt(server_app_3, True),
            b"Lorem\n\x17",
        )
    ...
    def test_chacha20_decrypt(self):
        server_1 = TlsRecord(
            bytearray(
                b"\x17\x03\x03\x00\x17y\xaf\xe4&6\xe0&\xf9\xd11: {\xe7\xac\x16;\xc7\xe5\xa6\xd7\xc8\xe4"
            ),
            [],
            True,
        )
        ...
        clint_app_1 = TlsRecord(
            bytearray(
                b"\x17\x03\x03\x00\x170?\xb8\x05\xff\x94\x1e\xd6\xff;\x88hR/~p\xfd\xbf\xb4\xd6\x08p\n"
            ),
            [],
            False,
        )
        server_app_3 = TlsRecord(
            bytearray(
                b"\x17\x03\x03\x00\x17X\xacv\xe6\xe9\xe6\xbd\xaf~\x08\xa3v\xba9S\xd8\xb3}JF\x13K\x0e"
            ),
            [],
            True,
        )
        ...
        self.assertEqual(
            self.tls_1_3_chacha20_poly1305_decryptor.decrypt(server_1, True),
            b"\x08\x00\x00\x02\x00\x00\x16",
        )
        self.assertEqual(
            self.tls_1_3_chacha20_poly1305_decryptor.decrypt(server_2, True),
            b"\x0b\x00\x03x\x00\x00\x03t\x00\x03o0\x82\x03k0\x82\x02S\xa0\x03\x02\x01\x02\x02\x14zC\xc1\xae\xee\x84$\xbc\xe2\x95\xd9h\xc5\x15V\xcc\xd3\xf8\x1e\x130\r\x06\t*\x86H\x86\xf7\r\x01\x01\x0b\x05\x000E1\x0b0\t\x06\x03U\x04\x06\x13\x02AU1\x130\x11\x06\x03U\x04\x08\x0c\nSome-State1!0\x1f\x06\x03U\x04\n\x0c\x18Internet Widgits Pty Ltd0\x1e\x17\r230926081013Z\x17\r240925081013Z0E1\x0b0\t\x06\x03U\x04\x06\x13\x02AU1\x130\x11\x06\x03U\x04\x08\x0c\nSome-State1!0\x1f\x06\x03U\x04\n\x0c\x18Internet Widgits Pty Ltd0\x82\x01\"0\r\x06\t*\x86H\x86\xf7\r\x01\x01\x01\x05\x00\x03\x82\x01\x0f\x000\x82\x01\n\x02\x82\x01\x01\x00\xdb\x85\xeb2^\xa7\x02y5\xf1}=\xad\xdf\x0c\xf6\xcd\xbc\x1e\xfe\x01\x195A~wI;1\xbe\xc11?\x06\xca\xb2\xac\xc7\xa1\xba\xb6\xe0\xd5\xb0+_\xa2i\xc4y\x97\x17\xcc&\xa4\x0cv\x8c\xb8\xb1\xbc\x89\x1e\xf1f_Z\xa1\x00\x0c\x01Hm\xae\xe6\x00K\xa2\xabj:6\xa7\x02`\xef\xeb\x95C\xc4\xa0\x1eH~]\xf6\xf9\xc5{\xbc\xa3\x9c\xd6\x9e\xf6\x88G\xbd\xa5\xa1\\\xa5\xdd>\xec\xc6\x03\x86\x101\x12\x1e)\xb7\xbdc\xdc(\xfe\xc4%\x14i3u\xe1\x93\xa4<G\x11\xf0\xe1\xd5\xe6\xdd\x14)\xf8\xc8\xa6\xd6S\xa0\xf5<\x1ep~\x1cD\x8c] P\xd8%t.\x85I\x9b\xd2\xdb\x14%wb\xfa\xd3\xd9\xdd\xcf\x05'(\x90\xbdY\x02\x1c\x18\x7f\xdfr\xc1dYr\x15\xe4\n\xd4\xdb\x1c\xc9G\xc7\xea\xe4\x1a\xc9\x12L\xeav.\xcb&z\t$\xa1\xbf\xc8t\xdbM\xc6+\xd26pC\xbey\xe6\x16rVn\xe9\x97\x9d[#dT\xa4\x91XR\xd8\xd5$E\x02\x03\x01\x00\x01\xa3S0Q0\x1d\x06\x03U\x1d\x0e\x04\x16\x04\x14\xdf3\xd5\xd9\xec\xd6\xab\xb0Fc\xd6t\\\xbdl\xb4l\x00\xf6x0\x1f\x06\x03U\x1d#\x04\x180\x16\x80\x14\xdf3\xd5\xd9\xec\xd6\xab\xb0Fc\xd6t\\\xbdl\xb4l\x00\xf6x0\x0f\x06\x03U\x1d\x13\x01\x01\xff\x04\x050\x03\x01\x01\xff0\r\x06\t*\x86H\x86\xf7\r\x01\x01\x0b\x05\x00\x03\x82\x01\x01\x002IA\xe21\x9a\xcaY\xc4\xba\xf4\xd6\xbe><\xcf\x81f\xac\x03\x03\xba\n<\xcc\xd0e\xf2\x07\xd4\xe3\x11u\x02*\x02\xf6u\x14n\xd7qz\xcd\x0ck\xbf;O\x8cA\xb0R\x8a\x86\xceg3hv.\x12\xa1\xb7\xfa{\xcf\x01qz\x95rn\xbb\x83B[~\x1110\xe7\xa9Z-\x9b\xbdR\x12\xa0mt\xf8iHL\xaa\x05jI\xc6\n\x84\xc9\xfbK\x8c\xd2\xe1\xe2s\xa1L\xe4J\x9d\xe6\xfeM\x82_\xcd\xe4s'I\xd9\xf7\xca0\x84\xaa\xef&\xd5\xd6\x82\xe3,\x8bp\xedH\x95\xfc\x15\xeaB\xaa\xac0\xa9\x84\x92\xed}\xb9\xc6\x8dg\x02Q\xf5k\x89\x04\xe1A\xc7\x99\x9b\xef;O2\x12\xa1u\x0eX\xfaz\x01\x1a\xe6+\x08w\x04\xb2\x0cja(\x13!\x19\x0ct\xf7\x05\xc5\xd1\n.\xbc\xc4\x83i9!\\\x89\x14\xd0XGM)\xeb+t\xfd\x00\x17\x89\xc4\x97{\x05U\x88\x8d\xec\x9a\x89\x96\xeb\xc7U%0NJ\xfd5\xb2\x0e\x94\xa9\xbf\xd7\xb6 #|\x00\x00\x16",
        )
        self.assertEqual(
            self.tls_1_3_chacha20_poly1305_decryptor.decrypt(server_3, True),
        ...
        self.assertEqual(
            self.tls_1_3_chacha20_poly1305_decryptor.decrypt(server_4, True),
        ...
        self.assertEqual(
            self.tls_1_3_chacha20_poly1305_decryptor.decrypt(clint_1, False),
        ...
        self.assertEqual(
            self.tls_1_3_chacha20_poly1305_decryptor.decrypt(server_app_1, True),
        ...
        self.assertEqual(
            self.tls_1_3_chacha20_poly1305_decryptor.decrypt(server_app_2, True),
        ...
        self.assertEqual(
            self.tls_1_3_chacha20_poly1305_decryptor.decrypt(clint_app_1, False),
            b"Lorem\n\x17",
        )
        self.assertEqual(
            self.tls_1_3_chacha20_poly1305_decryptor.decrypt(server_app_3, True),
            b"Lorem\n\x17",
        )
...
class TestSsl30Decryptor(TestCase):
    def setUp(self) -> None:
        self.ssl_3_0_rc4_decryptor = Decryptor(
            ARC4,
            None,
            SHA1,
            {
                ...
                "client_write_IV": b" \x1d\x8a\xfc",
                "server_write_IV": b"\xf3\x9f\t|",
            },
            TlsVersion.SSL30,
            16,
            20,
        ...
        self.ssl_3_0_aes_128_decryptor = Decryptor(
            AES,
            CBC,
            SHA1,
            {
                ...
                "server_write_IV": b"\x06d\xefLg\xc6;\xdb\x80\x96\x94R\xd1b[[",
            },
            TlsVersion.SSL30,
            16,
            20,
        ...
        self.ssl_3_0_aes_256_decryptor = Decryptor(
            AES,
            CBC,
            SHA1,
            {
                ...
                "server_write_IV": b"3\xf3\xedsE\x8a\xd4O\x01\x01\\/I~\x1f\x88",
            },
            TlsVersion.SSL30,
            32,
            20,
        ...
        self.ssl_3_0_3des_ebe_cbc_decryptor = Decryptor(
            TripleDES,
            CBC,
            SHA1,
            {
                ...
                "client_write_IV": b"\xd1\xa5\x01\x03\x93\x90\xc1\x8a",
                "server_write_IV": b"\xbbmG\xcb\x9f\xccx\xb5",
            },
            TlsVersion.SSL30,
            24,
            20,
        ...
        self.ssl_3_0_camellia_128_decryptor = Decryptor(
            Camellia,
            CBC,
            SHA1,
            {
        ...
        self.ssl_3_0_camellia_256_decryptor = Decryptor(
            Camellia,
            CBC,
            SHA1,
            {
    ...
    def test_aes_128_decrypt(self):
        ...
        self.assertEqual(
            self.ssl_3_0_aes_128_decryptor.decrypt(client_1, False),
            b"\x14\x00\x00$\xb8\xd6\xf9J\xaayR\xbd\xf4TY_\xe3N\xb7\x9ai\x85\x0f\x16\xb4s\x0c\xef\xc4\x88V\xe7VI\xa4\x04*L\xef#",
        )
        self.assertEqual(
            self.ssl_3_0_aes_128_decryptor.decrypt(server_1, True),
            b"\x14\x00\x00$\xb1nYG\xb8\xc6\x97\x00t\xee\xbf\xd0\xae\xfc\x0fLci\xf6z\xb5D\x85\xddgD\xbc\xa7\x1a\x88\xfc.\x10\xf1r{",
        )
        self.assertEqual(
            self.ssl_3_0_aes_128_decryptor.decrypt(client_2, False), b"Lorem\n"
        )
        self.assertEqual(
            self.ssl_3_0_aes_128_decryptor.decrypt(server_2, True), b"Lorem\n"
        )
    ...
    def test_3des_decrypt(self):
        ...
        client_2 = TlsRecord(
            bytearray(
                b"\x17\x03\x00\x00\x1c\xdaE\x89\xf8w\x12\xef|\xd1\\?tG\xb9\xddb(&\x93\xbb\tY\x1e\x19\xd4{\xc1*"
            ),
            [],
            False,
        )
        server_2 = TlsRecord(
            bytearray(
                b"\x17\x03\x00\x00\x1c\xd1\xcau8\x1ek\xdfuK\xd2\xd3\xe6[Y-\xe3=\xa0Mb\x1fSWYty\n\x01"
            ),
            [],
            True,
        )
        ...
        self.assertEqual(
            self.ssl_3_0_3des_ebe_cbc_decryptor.decrypt(client_1, False),
            b'\x14\x00\x00$\xea\x89\xf2,\xdd,\xd3\xf5\xcdS\xd9\xff\xb5"6\x7f\x8e\xf2\xb1a\xbe{\xb7T9O]\xed~}\xffO|\x9eZ\xb0',
        )
        self.assertEqual(
            self.ssl_3_0_3des_ebe_cbc_decryptor.decrypt(server_1, True),
            b'\x14\x00\x00$2\n\xa5\xfc\x96\x8c\x05\xf3\xd9^w8\xc9\x85R\x95|\xba#\xc2zX\xcd\xaf\xe5\xf4":/\xba\x0e\xcf\x08)\xee\xdf',
        )
        self.assertEqual(
            self.ssl_3_0_3des_ebe_cbc_decryptor.decrypt(client_2, False), b"Lorem\n"
        )
        self.assertEqual(
            self.ssl_3_0_3des_ebe_cbc_decryptor.decrypt(server_2, True), b"Lorem\n"
        )
    ...
    def test_camellia_128_decrypt(self):
        ...
        self.assertEqual(
            self.ssl_3_0_camellia_128_decryptor.decrypt(client_1, False),
            b"\x14\x00\x00$\xff\x0c\xc5C\x18\xbd\xa7\xa0\xc4\xc4\xe1\xbf\xe6$\xaeGz\x93\xb0\xcdA\x92\x8d3l\xbdFu\xf6}\xac$T\xb8%\x0e",
        )
        self.assertEqual(
            self.ssl_3_0_camellia_128_decryptor.decrypt(server_1, True),
            b"\x14\x00\x00$\x03urquaE\x05\x04\xbe'\xcc\xc0\x1fz\x06\x8b@5\xfaK\xb8x\xf6\xdf\xf6\xeej\x85+\x88\x81h\x9d\xa1>",
        )
        self.assertEqual(
            self.ssl_3_0_camellia_128_decryptor.decrypt(client_2, False), b"Lorem\n"
        )
        self.assertEqual(
            self.ssl_3_0_camellia_128_decryptor.decrypt(server_2, True), b"Lorem\n"
        )
    ...
    def test_camellia_256_decrypt(self):
        ...
        self.assertEqual(
            self.ssl_3_0_camellia_256_decryptor.decrypt(client_1, False),
            b"\x14\x00\x00$'<&\xd6\xbc\x98\xd5\x1a\x07K\x96\xdde\x98\x91\xb7\xf4\xea5\x8f]x>\x9a\x14<\x82\xf4\xd8U\xfb\xd7\x08k\xe9&",
        )
        self.assertEqual(
            self.ssl_3_0_camellia_256_decryptor.decrypt(server_1, True),
        ...
        self.assertEqual(
            self.ssl_3_0_camellia_256_decryptor.decrypt(client_2, False), b"Lorem\n"
        )
        self.assertEqual(
            self.ssl_3_0_camellia_256_decryptor.decrypt(server_2, True), b"Lorem\n"
        )


class TestTls12Decryptor(TestCase):
    def setUp(self) -> None:
        self.tls_1_2_3des_ebe_cbc_decryptor = Decryptor(
            TripleDES,
            CBC,
            SHA1,
            {
                ...
                "client_write_IV": b"@\xdf'\xfc",
                "server_write_IV": b"yE\x7f3",
            },
            TlsVersion.TLS12,
            24,
            20,
        ...
        self.tls_1_2_aes_128_ccm_decryptor = Decryptor(
            AESCCM,
            AESCCM,
            SHA256,
            {
        ...
        self.tls_1_2_aes_256_ccm_8_decryptor = Decryptor(
            AESCCM,
            AESCCM,
            SHA256,
            {
        ...
        self.tls_1_2_aes_256_cbc_decryptor = Decryptor(
            AES,
            CBC,
            SHA1,
            {
        ...
        self.tls_1_2_aes_256_gcm_decryptor = Decryptor(
            AESGCM,
            GCM,
            SHA384,
            {
        ...
        self.tls_1_2_chacha20_poly1305_decryptor = Decryptor(
            ChaCha20Poly1305,
            ChaCha20Poly1305,
            SHA256,
            {
        ...
        self.tls_1_2_rc4_128_decryptor = Decryptor(
            ARC4,
            None,
            SHA1,
            {
                ...
                "server_write_key": b"\xc8\xea\x0b7\xb4\xfa10uQu\x03\x1e>\xa0\x1d",
                "client_write_IV": b"\xb0\xc7&\xa5",
        ...
        self.tls_1_2_camellia_128_decryptor = Decryptor(
            Camellia,
            CBC,
            SHA1,
            {
    ...
    def test_3des_decrypt(self):
        ...
        self.assertEqual(
            self.tls_1_2_3des_ebe_cbc_decryptor.decrypt(client_1, False),
            b"\x14\x00\x00\x0cO_y6f\x91{\xb4m\x04\x00\xd0",
        )
        self.assertEqual(
            self.tls_1_2_3des_ebe_cbc_decryptor.decrypt(server_1, True),
            b"\x14\x00\x00\x0c\x06Y\x94jpU\xb9\xadC\xbalW",
        )
        self.assertEqual(
            self.tls_1_2_3des_ebe_cbc_decryptor.decrypt(client_2, False), b"Lorem\n"
        )
        self.assertEqual(
            self.tls_1_2_3des_ebe_cbc_decryptor.decrypt(server_2, True), b"Lorem\n"
        )
    ...
    def test_aes_128_ccm_decrypt(self):
        ...
        self.assertEqual(
            self.tls_1_2_aes_128_ccm_decryptor.decrypt(client_1, False),
            b"\x14\x00\x00\x0cr1-L\xd1\x81\xe8\xe4\xe3\xd8\x1f\x06",
        )
        self.assertEqual(
            self.tls_1_2_aes_128_ccm_decryptor.decrypt(server_1, True),
            b"\x14\x00\x00\x0cp\xbd2\xe2\xbb\xeb1P\xdd\xbf\xa4\xb0",
        )
        self.assertEqual(
            self.tls_1_2_aes_128_ccm_decryptor.decrypt(client_2, False), b"Lorem\n"
        )
        self.assertEqual(
            self.tls_1_2_aes_128_ccm_decryptor.decrypt(server_2, True), b"Lorem\n"
        )
    ...
    def test_aes_256_ccm_8_decrypt(self):
        ...
        client_2 = TlsRecord(
            bytearray(
                b"\x17\x03\x03\x00\x16\x00\x00\x00\x00\x00\x00\x00\x01\xfc\xba\x17++\xcd1\x8d\xb53@n\xa1\\"
            ),
            [],
            False,
        )
        server_2 = TlsRecord(
            bytearray(
                b"\x17\x03\x03\x00\x16\x00\x00\x00\x00\x00\x00\x00\x01PRm\x92\x81^FD\x8f\xe1\xb1\xbaT\xab"
            ),
            [],
            True,
        )
        ...
        self.assertEqual(
            self.tls_1_2_aes_256_ccm_8_decryptor.decrypt(client_1, False),
            b"\x14\x00\x00\x0cP\x88_\xec\x89\x88g\xb1\x99P\x1bW",
        )
        self.assertEqual(
            self.tls_1_2_aes_256_ccm_8_decryptor.decrypt(server_1, True),
            b"\x14\x00\x00\x0c\xc3T\x05\xda\x9dH\xfe\x9b\xcc\xf3\xf3\x84",
        )
        self.assertEqual(
            self.tls_1_2_aes_256_ccm_8_decryptor.decrypt(client_2, False), b"Lorem\n"
        )
        self.assertEqual(
            self.tls_1_2_aes_256_ccm_8_decryptor.decrypt(server_2, True), b"Lorem\n"
        )
    ...
    def test_aes_256_cbc_decrypt(self):
        ...
        self.assertEqual(
            self.tls_1_2_aes_256_cbc_decryptor.decrypt(client_1, False),
            b"\x14\x00\x00\x0c\xf8\xd2\xe3\x86\xde&7?\xd0\xdd-\x80",
        )
        self.assertEqual(
            self.tls_1_2_aes_256_cbc_decryptor.decrypt(server_1, True),
            b"\x14\x00\x00\x0c\x13\xa1\xb0\xa4\xd91\xcf\xac\x87\x1e\xe3\xce",
        )
        self.assertEqual(
            self.tls_1_2_aes_256_cbc_decryptor.decrypt(client_2, False), b"Lorem\n"
        )
        self.assertEqual(
            self.tls_1_2_aes_256_cbc_decryptor.decrypt(server_2, True), b"Lorem\n"
        )
    ...
    def test_aes_256_gcm_decrypt(self):
        ...
        self.assertEqual(
            self.tls_1_2_aes_256_gcm_decryptor.decrypt(client_1, False),
            b"\x14\x00\x00\x0c\xe2~t\x85W\x10\x99\xcf\xfd\x1e\xa06",
        )
        self.assertEqual(
            self.tls_1_2_aes_256_gcm_decryptor.decrypt(server_1, True),
            b'\x14\x00\x00\x0c\xbf\x93"G\xbf\x9e\x96\xeb\xab]\t\xa0',
        )
        self.assertEqual(
            self.tls_1_2_aes_256_gcm_decryptor.decrypt(client_2, False), b"Lorem\n"
        )
        self.assertEqual(
            self.tls_1_2_aes_256_gcm_decryptor.decrypt(server_2, True), b"Lorem\n"
        )
    ...
    def test_chacha20_poly1305_decrypt(self):
        ...
        server_2 = TlsRecord(
            bytearray(
                b'\x17\x03\x03\x00\x16\xe24Gl"?*\xbb\xd4o\x8fN\xa2\xd7Z\x85w-\xb5\x1aU\xce'
            ),
            [],
            True,
        )
        ...
        self.assertEqual(
            self.tls_1_2_chacha20_poly1305_decryptor.decrypt(client_1, False),
            b"\x14\x00\x00\x0c\xde\xbf\xc5_\xf27\xc2\x16c\x89\x8a\xf9",
        )
        self.assertEqual(
            self.tls_1_2_chacha20_poly1305_decryptor.decrypt(server_1, True),
            b"\x14\x00\x00\x0c\xc8\xf7\xd2\xda,F\xd05q.\xb2\xe4",
        )
        self.assertEqual(
            self.tls_1_2_chacha20_poly1305_decryptor.decrypt(client_2, False),
            b"Lorem\n",
        )
        self.assertEqual(
            self.tls_1_2_chacha20_poly1305_decryptor.decrypt(server_2, True), b"Lorem\n"
        )
    ...
    def test_rc4_128_decrypt(self):
        ...
        client_2 = TlsRecord(
            bytearray(
                b"\x17\x03\x03\x00\x1a\x9d?\xb7\xa4+wh=\xb3Z\xd7\x96\x96[\x97\xb5%\xf4,\x17=\x1d\xfcf<\xf1"
            ),
            [],
            False,
        )
        server_2 = TlsRecord(
            bytearray(
                b"\x17\x03\x03\x00\x1aF\xd7ys\x9d\x0f!\xfa\xb8u\x92\xbdQ\xe3\x9eT\xe5\x8bC%3mtz\xad\x1d"
            ),
            [],
            True,
        )
        ...
        self.assertEqual(
            self.tls_1_2_rc4_128_decryptor.decrypt(client_1, False),
            b"\x14\x00\x00\x0c\xb2@\t\xa8\x8dQE\xbf$S/h",
        )
        self.assertEqual(
            self.tls_1_2_rc4_128_decryptor.decrypt(server_1, True),
            b"\x14\x00\x00\x0c\xae\x9d\x98\xf8.\xb8\x12\xa0\xc2\x12\xba\xae",
        )
        self.assertEqual(
            self.tls_1_2_rc4_128_decryptor.decrypt(client_2, False), b"Lorem\n"
        )
        self.assertEqual(
            self.tls_1_2_rc4_128_decryptor.decrypt(server_2, True), b"Lorem\n"
        )
    ...
    def test_camellia_128_cbc_decrypt(self):
        ...
        self.assertEqual(
            self.tls_1_2_camellia_128_decryptor.decrypt(client_1, False),
            b"\x14\x00\x00\x0c9\xb6\x95W\xc8\xc7K\xfd\x91\x11\xd8)",
        )
        self.assertEqual(
            self.tls_1_2_camellia_128_decryptor.decrypt(server_1, True),
            b"\x14\x00\x00\x0c+dn\x1f,\xb0T\x933\xcf\xf1\x1a",
        )
        self.assertEqual(
            self.tls_1_2_camellia_128_decryptor.decrypt(client_2, False), b"Lorem\n"
        )
        self.assertEqual(
            self.tls_1_2_camellia_128_decryptor.decrypt(server_2, True), b"Lorem\n"
        )


class TestTls10Decryptor(TestCase):
    def setUp(self) -> None:
        self.tls_1_0_3des_ebe_cbc_decryptor = Decryptor(
            TripleDES,
            CBC,
            SHA1,
            {
                "client_write_MAC_secret": bytearray(
                    b'\xd3\xc1"\x82\x0f\xb2&\xabg\x9ei\x13\xe5\'\x14\xaa"\x93\xc5\xc2'
                ),
                "server_write_MAC_secret": bytearray(
                    b"\x1f\xb0\xd8N\xeb\xe0\x04\x9ai\xd1=o\xcd\xc6\xe3\xf4\xbbP\x16g"
                ),
                "client_write_key": bytearray(
                    b"-z\xfb\x02lA\xe2O\x98yE\xb7\x9c1{;\x9a\xdb\xc7\xe2C\xfa_Q"
                ),
                "server_write_key": bytearray(
                    b"W\xd6],\x1cX\xd6\x92p\xff\x1d\x8a\xf37L\t\x17\xee^a\x8f\xb3\x03\xf6"
                ),
        ...
        self.tls_1_0_aes_128_cbc_decryptor = Decryptor(
            AES,
            CBC,
            SHA1,
            {
                "client_write_MAC_secret": bytearray(
                    b"az\xb4O\xad}\xe9(\xcf~\x8c@\xe1\x86\xc3H\xa2_)\x0b"
                ),
                "server_write_MAC_secret": bytearray(
                    b"y\xcb\x03\r\xf0n\xf5`\xc7bc\xcd\x15\xc5\xe7y\xbd2\xadh"
                ),
                "client_write_key": bytearray(
                    b"\xc4x?\xce\x86\xcd\xde4$\x84g\x13\xe3\xdfUq"
                ),
                "server_write_key": bytearray(
                    b"\x90\n\x14}1\xa6P\x03E\xd5n\xa9\x8d\x1e|p"
                ),
                "client_write_IV": bytearray(
                    b"\xc1N\xcbW\x85\xee\xc1r\xed\x80\xaf\\\x16\x93\xa1d"
                ),
                "server_write_IV": bytearray(
                    b"\x8d\xb1\xacT\xe6UT\xf4-\x7f\xad\x9e\xc6I\xac\xb4"
                ),
            },
            TlsVersion.TLS10,
            16,
        ...
        self.tls_1_0_camellia_cbc_decryptor = Decryptor(
            Camellia,
            CBC,
            SHA1,
            {
                "client_write_MAC_secret": bytearray(
                    b"\xd8wH\x9cE!\xf9\x1d\x01\x93O\x0eH\xf9)\xf7\x17>`\x01"
                ),
                "server_write_MAC_secret": bytearray(
                    b"\xa7Pk9X\xbe:\xe7\tQ\xa2yc\xa5\x97C\xc7\xd6s*"
                ),
                "client_write_key": bytearray(
                    b"{\x12\x9d\xc5\x17\xa9\xa0\n\x10\xd8\x9d\xb9L\t\x94="
                ),
                "server_write_key": bytearray(
                    b"\xa3\x1a\xc6H\xaa\xaa\x99\xf6w\xbcr=\x1c\xbeK\xfd"
                ),
                "client_write_IV": bytearray(
                    b"\xca,\xc5\xad\xe0\x11EVPSk\xd8\xbf\x86\x02'"
                ),
        ...
        self.tls_1_0_rc4_128_decryptor = Decryptor(
            ARC4,
            None,
            SHA1,
            {
                "client_write_MAC_secret": bytearray(
                    b"\xa1x[Gn\x91\xa7\xb6w\x97pCZ\xc6\xf8\xa3\xa5\xc3J\xcb"
                ),
                "server_write_MAC_secret": bytearray(
                    b"\xbb\xa3\xe4ncQ\x05\x8d\xa3\x1e0\x87\xf2\x00\x06\x89y\xb5T`"
                ),
                "client_write_key": bytearray(
                    b"\xfe\x0c\x16:\xf4la.+\xa4\xad\xe5\xaf\x99v\xce"
                ),
                "server_write_key": bytearray(
                    b"\xaa\xc3\xefa\xc0\x86\x0fEB\xc3\x95\x82\x81\x11\xb7\xa6"
                ),
                "client_write_IV": bytearray(b"\xdbj\xe5\x99"),
                "server_write_IV": bytearray(b"\x82\xbf\xd9\xd4"),
            },
            TlsVersion.TLS10,
            16,
            20,
    ...
    def test_3des_decrypt(self):
        ...
        server_2 = TlsRecord(
            bytearray(
                b"\x17\x03\x01\x00\x1c\xcb;qn115\x17Jd.\xd1i\xee\xfa\x03*\n\xd7\x8a)r<\x8d\x83\xe6\xc2a"
            ),
            [],
            True,
        )
        ...
        self.assertEqual(
            self.tls_1_0_3des_ebe_cbc_decryptor.decrypt(client_1, False),
            b"\x14\x00\x00\x0cQ-\xf5\xe1\x01~\xe5\xc0\xcd\xe69^",
        )
        self.assertEqual(
            self.tls_1_0_3des_ebe_cbc_decryptor.decrypt(server_1, True),
            b"\x14\x00\x00\x0c3Q\xe8\xb9&hb\x0b\x9dX\xa7n",
        )
        self.assertEqual(
            self.tls_1_0_3des_ebe_cbc_decryptor.decrypt(client_2, False), b"Lorem\n"
        )
        self.assertEqual(
            self.tls_1_0_3des_ebe_cbc_decryptor.decrypt(server_2, True), b"Lorem\n"
        )
    ...
    def test_aes_128_decrypt(self):
        ...
        self.assertEqual(
            self.tls_1_0_aes_128_cbc_decryptor.decrypt(client_1, False),
            b"\x14\x00\x00\x0c+Y\xeb\xb6N\xa8^|\xb8\x7fc`",
        )
        self.assertEqual(
            self.tls_1_0_aes_128_cbc_decryptor.decrypt(server_1, True),
            b"\x14\x00\x00\x0c2\xe5\xb7\x01\xb1X\x97*\xaa^\xf7\xdb",
        )
        self.assertEqual(
            self.tls_1_0_aes_128_cbc_decryptor.decrypt(client_2, False), b"Lorem\n"
        )
        self.assertEqual(
            self.tls_1_0_aes_128_cbc_decryptor.decrypt(server_2, True), b"Lorem\n"
        )
    ...
    def test_camellia_128_decrypt(self):
        ...
        self.assertEqual(
            self.tls_1_0_camellia_cbc_decryptor.decrypt(client_1, False),
            b"\x14\x00\x00\x0cb\xb1k\xb7\x98u\xfe\xc30^\x16\xc6",
        )
        self.assertEqual(
            self.tls_1_0_camellia_cbc_decryptor.decrypt(server_1, True),
            b"\x14\x00\x00\x0cmsb\x1a\xd3\xe2\xdf\xc4s@\x1d\xd0",
        )
        self.assertEqual(
            self.tls_1_0_camellia_cbc_decryptor.decrypt(client_2, False), b"Lorem\n"
        )
        self.assertEqual(
            self.tls_1_0_camellia_cbc_decryptor.decrypt(server_2, True), b"Lorem\n"
        )
    ...
    def test_rc4_128_decrypt(self):
        ...
        server_2 = TlsRecord(
            bytearray(
                b"\x17\x03\x01\x00\x1a\x96\x11qBn:\x91\x08/Z\x14\xce'\xaf\xe7\xd2s\x88\x9e\x1e\x046{uwy"
            ),
            [],
            True,
        )
        ...
        self.assertEqual(
            self.tls_1_0_rc4_128_decryptor.decrypt(client_1, False),
            b"\x14\x00\x00\x0c\xb9\xae\xf9\xc8\x1f\x8d\xa2\xb5U\xf5\x15\x07",
        )
        self.assertEqual(
            self.tls_1_0_rc4_128_decryptor.decrypt(server_1, True),
            b"\x14\x00\x00\x0c\x84\xff\x0c\x1f\xff\xd5\xe7\xa4\x12\x1f_\xc3",
        )
        self.assertEqual(
            self.tls_1_0_rc4_128_decryptor.decrypt(client_2, False), b"Lorem\n"
        )
        self.assertEqual(
            self.tls_1_0_rc4_128_decryptor.decrypt(server_2, True), b"Lorem\n"
        )


class TestTls11Decryptor(TestCase):
    def setUp(self) -> None:
        self.tls_1_1_3des_ebe_cbc_decryptor = Decryptor(
            TripleDES,
            CBC,
            SHA1,
            {
                "client_write_MAC_secret": bytearray(
                    bytes.fromhex("39616b365fff3df25f8f780cc6f793548d83e730")
                ),
                "server_write_MAC_secret": bytearray(
                    bytes.fromhex("30eb4e4b4329d46eec9f623aa19dec93eaca783c")
                ),
                "client_write_key": bytearray(
                    bytes.fromhex("6423cd5561a7925d2e726277f970477d57161676b94662dc")
                ),
                "server_write_key": bytearray(
                    bytes.fromhex("1e3401fe31c007ea808c4aac7638792e8089ee02b31a6f30")
                ),
        ...
        self.tls_1_1_aes_128_cbc_decryptor = Decryptor(
            AES,
            CBC,
            SHA1,
            {
                "client_write_MAC_secret": bytearray(
                    bytes.fromhex("15289ce0eee45cef881e4e2603ab0df03a3a02a4")
                ),
                "server_write_MAC_secret": bytearray(
                    bytes.fromhex("d0bfbdcd64aa4b74c9099cbcb53a0d4ef526789b")
                ),
                "client_write_key": bytearray(
                    bytes.fromhex("a8f26e8c819162f0f0bc2643d5a7e6aa")
                ),
                "server_write_key": bytearray(
                    bytes.fromhex("70bf9b08939e5de976bf7db9b8af8085")
                ),
                "client_write_IV": bytearray(
                    bytes.fromhex("636f460016cfe020d69bee980568b5dc")
                ),
                "server_write_IV": bytearray(
                    bytes.fromhex("1d4882d8f369e0dfa182dc9b1aaeede0")
                ),
            },
            TlsVersion.TLS11,
            16,
        ...
        self.tls_1_1_rc4_128_decryptor = Decryptor(
            ARC4,
            None,
            SHA1,
            {
                "client_write_MAC_secret": bytearray(
                    bytes.fromhex("eef331005352271862a248691f7ca93f3266059c")
                ),
                "server_write_MAC_secret": bytearray(
                    bytes.fromhex("0e8d276e707c2acd0f9997560c029e12b4dbc45d")
                ),
                "client_write_key": bytearray(
                    bytes.fromhex("ba47c191eb1a1fe244fec9047deca488")
                ),
                "server_write_key": bytearray(
                    bytes.fromhex("68c18974503f4745d9bdb3d22391ed40")
                ),
        ...
        self.tls_1_1_camellia_128_decryptor = Decryptor(
            Camellia,
            CBC,
            SHA1,
            {
                "client_write_MAC_secret": bytearray(
                    b"\x0c0\xf2\x86\xff\xc4\xd0\xb2F\x1c\xd0\xad@a^\x88\xa7\xee\xebQ"
                ),
                "server_write_MAC_secret": bytearray(
                    b"T\x9fZ\x10\xe7\x99J\xcc\x98\xf6\xf6\xfdGD\x7f\xc1\xcdE\xe1\xec"
                ),
                "client_write_key": bytearray(
                    b"\x1b\xa41\xb7<\xa5\x05d\x12\x8f\x104\xe4\x18?&"
                ),
                "server_write_key": bytearray(
                    b"\xa6H\xca\xbadV\xc9\xa0\xc8\x05\x81\x8a%\x9c\x1a,"
                ),
                "client_write_IV": bytearray(
                    b"\xcd\x99\x91%\xd0\x97\xf7'\x00\xdb\x15\x97\xe4\xe52\xa6"
                ),
                "server_write_IV": bytearray(
                    b"\x0e\xa5\xc7<\xa8\xfdh\xa03\xe9\x9d^\xf3ZS]"
                ),
            },
            TlsVersion.TLS11,
            16,
    ...
    def test_rc4_128_decrypt(self):
        client_1 = TlsRecord(
            bytearray(
                bytes.fromhex(
                    "16030200249e4df38e2b00e80a8efbb44ae81371380f303da75ebb2be8aeeb76c6d1cfb8b096990c5d"
                )
            ),
            [],
            False,
        ...
        server_1 = TlsRecord(
            bytearray(
                bytes.fromhex(
                    "16030200241efef13ad248bddc7ef95b37cf489f4b7f9b65cb67022f6bddf1f126ccc065cd299a075e"
                )
            ),
            [],
            True,
        ...
        client_2 = TlsRecord(
            bytearray(
                bytes.fromhex(
                    "170302001a8edd0a0cb37e21d33469fb15d4bc465981641c83d65499838a60"
                )
            ),
            [],
            False,
        ...
        server_2 = TlsRecord(
            bytearray(
                bytes.fromhex(
                    "170302001a495dc65bf43568edaac343d46324ffd410f28c67e1dac86b0cc3"
                )
            ),
            [],
            True,
        ...
        self.assertEqual(
            self.tls_1_1_rc4_128_decryptor.decrypt(client_1, False),
            bytes.fromhex("1400000c2e688145acfbf3300dac5a74"),
        )
        self.assertEqual(
            self.tls_1_1_rc4_128_decryptor.decrypt(server_1, True),
            bytes.fromhex("1400000ca8f7bd029d49e9891812987f"),
        )
        self.assertEqual(
            self.tls_1_1_rc4_128_decryptor.decrypt(client_2, False), b"Lorem\n"
        )
        self.assertEqual(
            self.tls_1_1_rc4_128_decryptor.decrypt(server_2, True), b"Lorem\n"
        )
    ...
    def test_3des_cbc(self):
        ...
        client_2 = TlsRecord(
            bytearray(
                bytes.fromhex(
                    "1703020024da3fb743b8462144de44c121fa7e692a5ff9a3d6eb6abaac9b973c0e4dac2d04bd0ff75f"
                )
            ),
            [],
            False,
        ...
        server_2 = TlsRecord(
            bytearray(
                bytes.fromhex(
                    "170302002446ab01db8d781804ae56806ea5be325ac727a2bd87e2372af9eb0435f5c4fdb2e24d91ef"
                )
            ),
            [],
            True,
        ...
        self.assertEqual(
            self.tls_1_1_3des_ebe_cbc_decryptor.decrypt(client_1, False),
            bytes.fromhex("1400000c0fd63ad3c6a6c4f43d623664"),
        )
        self.assertEqual(
            self.tls_1_1_3des_ebe_cbc_decryptor.decrypt(server_1, True),
            bytes.fromhex("1400000c1a23892cbec6a18449cafc17"),
        )
        self.assertEqual(
            self.tls_1_1_3des_ebe_cbc_decryptor.decrypt(client_2, False), b"Lorem\n"
        )
        self.assertEqual(
            self.tls_1_1_3des_ebe_cbc_decryptor.decrypt(server_2, True), b"Lorem\n"
        )
    ...
    def test_aes_128_cbc(self):
        ...
        self.assertEqual(
            self.tls_1_1_aes_128_cbc_decryptor.decrypt(client_1, False),
            bytes.fromhex("1400000c7292f2e28646aee41df6a6ab"),
        )
        self.assertEqual(
            self.tls_1_1_aes_128_cbc_decryptor.decrypt(server_1, True),
            bytes.fromhex("1400000c1c3dd463abb7d5654e24b23a"),
        )
        self.assertEqual(
            self.tls_1_1_aes_128_cbc_decryptor.decrypt(client_2, False), b"Lorem\n"
        )
        self.assertEqual(
            self.tls_1_1_aes_128_cbc_decryptor.decrypt(server_2, True), b"Lorem\n"
        )
    ...
    def test_camellia_128_cbc(self):
        ...
        self.assertEqual(
            self.tls_1_1_camellia_128_decryptor.decrypt(client_1, False),
            b"\x14\x00\x00\x0c\xa3\t\xb1\x9d\x1e\x18\x87r\xc3\x12}\xc9",
        )
        self.assertEqual(
            self.tls_1_1_camellia_128_decryptor.decrypt(server_1, True),
            b"\x14\x00\x00\x0c\xa4!\x7f\xce\x90m\xaf\xd3gD\x10\xa3",
        )
        self.assertEqual(
            self.tls_1_1_camellia_128_decryptor.decrypt(client_2, False), b"Lorem\n"
        )
        self.assertEqual(
            self.tls_1_1_camellia_128_decryptor.decrypt(server_2, True), b"Lorem\n"
        )
