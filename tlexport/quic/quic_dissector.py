                ...
                case 0x01:  # if header is long header
                    ...
                    match packet_type:  # checks if packet type
                        ...
                        case 0x00:  # Initial packet
                            ...
                            if int.from_bytes(version, "big") == 1:
                                initial_keys = dev_initial_keys(dcid, QuicVersion.V1)
                            elif int.from_bytes(version, "big") == 2:
                                initial_keys = dev_initial_keys(dcid, QuicVersion.V2)
                            else:
                                initial_keys = dev_initial_keys(dcid, QuicVersion.UNKNOWN)
                            ...
                            hp_key = bytes.fromhex("9f50449e04a0e810283a1e9933adedd2")
